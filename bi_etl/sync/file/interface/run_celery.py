...
/usr/local/python3/bin/flower -A ecsage_bigdata_etl_engineering.bi_etl.sync.file.interface.tylerscope --broker_api=http://root:1qazXSW2@192.168.30.17:9548/api/ --port=9544
