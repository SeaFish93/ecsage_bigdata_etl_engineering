...
git pull
 ...
 #腾讯
 nohup /usr/local/python3/bin/celery -A ecsage_bigdata_etl_engineering.bi_etl.sync.file.interface.tylerscope worker --concurrency=100 -l info -n tc_test.%h -Q tc_test >/tmp/tc_celery.log 2>&1 &
 #报表接口
