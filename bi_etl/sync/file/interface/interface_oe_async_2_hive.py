...
def get_etl_mid_2_ods(AirflowDagId="",AirflowTaskId="",TaskInfo="",MediaType="",ExecDate=""):
    ...
    insert_sql = """
       ...
       where rn = 1
    """%(target_db,target_table,ExecDate,select_target_columns,select_source_columns.replace("""null as `returns_account_id`""","""`advertiser_id` as `returns_account_id`"""),key,source_db,source_table,ExecDate)
