...
def get_pages_hour(UrlPath="",ParamJson="",ServiceCode="",Token="",DataFileDir="",DataFile="",
              ReturnAccountId="",TaskFlag="",PageTaskFile="",TaskExceptionFile="",
              Pagestyle="",ArrayFlag="",TargetFlag="oe"):
    set_true = True
    n = 0
...
#处理不分页
@app.task(rate_limit='2000/m')
def get_not_page_hour(UrlPath="",ParamJson="",ServiceCode="",Token="",ReturnAccountId="",
                 TaskFlag="",DataFileDir="",DataFile="",TaskExceptionFile="",
                 ArrayFlag="",TargetFlag="oe"):
    set_true = True
    n = 0
...
#获取代理下子账户页数 hour
@app.task(rate_limit='1000/m')
def get_service_page_data_hour(ServiceId="",ServiceCode="",Media="",Page="",PageSize="",
                          DataFile="",PageFileData="",TaskFlag=""):
    set_true = True
    n = 0
    while set_true:
...
#获取代理下子账户hour
@app.task(rate_limit='1000/m')
def get_service_data_hour(ServiceId="",ServiceCode="",Media="",Page="",PageSize="",
                     DataFile="",PageFileData="",TaskFlag="",TaskExceptionFile=""):
    set_true = True
    n = 0
    while set_true:
